...
const arrPlayer = Array.from(playersData)
console.log('arrayPlayer',arrPlayer)
   console.log('playerset',playersData)
                    ...
                    <div
                        ...
                        {loading ? <>
                            ...
                            <>
                                ...
                                <div className="absolute top-2 right-2 z-20 font-black text-gray-600 text-4xl opacity-70">{fields.nummer}</div>
                                <Image layout='fill' src={`${fields.image ? 'https:'+fields.image.fields.file.url : '/images/players/user-default.png'}`} className='transition-all duration-500 group-hover:scale-110 z-10 max-w-[14rem] w-full max-h-[20rem] object-cover' />
                                <div
                                    style={{
